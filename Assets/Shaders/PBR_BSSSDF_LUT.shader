Shader "PBR/PBR_BRDF_LUT"
{
    ...
    SubShader
    {
        ...
        fixed4 frag (v2f i) : SV_Target
        {
            ...
            half r = fwidth(i.pos_world) / fwidth(i.normal_world);
            fixed ndotl_normal = (dot(n, l) + 1.0) * 0.5 + _KdKsExpoureParalxScale.z;
            fixed3 ndotl = tex2D(_LUT_SSS, half2(ndotl_normal, r)).rgb;
